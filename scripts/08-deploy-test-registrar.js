...
async function main() {
  console.log('\n🚀 Deploying SubnameRegistrar for test.divicompany.eth');
  ...
  // Calculate namehash for test.divicompany.eth
  ...
  // Verify you own test.divicompany.eth in Name Wrapper
  ...
  fs.writeFileSync('./test-registrar-config.json', JSON.stringify(deploymentInfo, null, 2));
  console.log('💾 Config saved to test-registrar-config.json\n');
  
  console.log('━'.repeat(60));
  console.log('✅ DEPLOYMENT COMPLETE!');
  console.log('━'.repeat(60));
  console.log('\n🎯 Next Steps:');
  console.log('   1. Approve this registrar to manage test.divicompany.eth:');
  console.log('      (This grants permission to create subdomains)\n');
  console.log('   2. Test renting a subdomain:');
  console.log('      npx hardhat run scripts/test-test-registrar.js --network sepolia\n');
